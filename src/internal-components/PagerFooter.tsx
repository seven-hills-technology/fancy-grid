    ...
    return (
        <tfoot>
            <tr>
                ...
                <td> {(((props.pageState.page + 1) * props.pageState.pageSize) - props.pageState.pageSize ) + 1 + " - " + ((props.pageState.page * props.pageState.pageSize) + props.dataRows.length) + " of " + props.pageState.count + " items"}
                </td>
            </tr>
        </tfoot>
    )
